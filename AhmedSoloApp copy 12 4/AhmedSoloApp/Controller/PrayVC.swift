...
class TimePray: UIViewController {
    
    //@IBOutlet weak var nextslah: UIButton!
...
extension TimePray: UITableViewDataSource {
...
class PrayTime {
    ...
    // Time Names
    var timeNames: NSArray = ["الفجر", "الشروق", "الظهر", "العصر", "الغروب", "المغرب", "العشاء"]
    ...
    func tune(offsetTimes:NSMutableDictionary) {
        offsets?.replaceObject(at: 0, with: offsetTimes.object(forKey: "الفجر")!)
        offsets?.replaceObject(at: 1, with: offsetTimes.object(forKey: "الشروق")!)
        offsets?.replaceObject(at: 2, with: offsetTimes.object(forKey: "الظهر")!)
        offsets?.replaceObject(at: 3, with: offsetTimes.object(forKey: "العصر")!)
        offsets?.replaceObject(at: 4, with: offsetTimes.object(forKey: "الغروب")!)
        offsets?.replaceObject(at: 5, with: offsetTimes.object(forKey: "المغرب")!)
        offsets?.replaceObject(at: 6, with: offsetTimes.object(forKey: "العشاء")!)
    }
